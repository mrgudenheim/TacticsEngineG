...
func get_potential_targets(_action_instance: ActionInstance) -> Array[TerrainTile]:
	push_error("Using base TargetingStrategy instead of specific targeting strategy")
	return []


func get_aoe_targets(_action_instance: ActionInstance, _tile_target: TerrainTile) -> Array[TerrainTile]:
...
func stop_targeting(_action_instance: ActionInstance) -> void:
	push_error("Using base TargetingStrategy instead of specific targeting strategy")
